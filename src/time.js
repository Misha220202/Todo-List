...
function showCurrentTimeFormatted() {
    const now = new Date();
...
export const currentTimeFormatted = () => format(new Date(), 'yyyy-MM-dd HH:mm:ss.SSS');
...
export const nextSundayFormatted = () => isSunday(currentDate()) ? currentDateFormatted() : format(nextSunday(currentDate()), 'yyyy-MM-dd');