...
const essentialsTask3 = new ProjectTask('Dairy 🥛', 'Milk, Yoghurt, Butter, etc.', currentDateFormatted(), 'notChecked', 0, 'notImportant', 'Essentials');
const essentialsTask4 = new ProjectTask('Drinks 💧', 'Sparkling water, Orange juice, etc.', currentDateFormatted(), 'notChecked', 0, 'notImportant', 'Essentials');
const essentialsTask5 = new ProjectTask('Household 🏠', 'Dish soap, Detergent, 20 watt light bulb, etc.', currentDateFormatted(), 'notChecked', 0, 'notImportant', 'Essentials');
