...
export const removeChosenFromClasslist = () => {
    Array.from(tasksControlPanel.children).forEach(child => child.classList.remove('chosen')); Array.from(projectsControlPanel.children).forEach(child => child.classList.remove('chosen'));
}